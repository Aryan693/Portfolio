      ...
      >
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-6 md:p-8 relative overflow-hidden group">
          ...
          <p className="text-lg text-foreground/80 leading-relaxed mb-8">
            ...
            Microsoft Fabric. From RAG-based legal compliance tools to medallion architecture data pipelines — 
            I work across the full AI/Data stack.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center gap-3 bg-black/40 border border-white/10 rounded-lg p-4 group/chip hover:border-accent/50 transition-colors">
              <Award className="w-5 h-5 text-accent flex-shrink-0" />
              <div className="flex flex-col">
                <span className="text-sm font-bold text-white">JEE AIR 2408</span>
                <span className="text-xs text-foreground/60">Top 0.21%</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 bg-black/40 border border-white/10 rounded-lg p-4 group/chip hover:border-accent/50 transition-colors">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-bold text-white">Microsoft Certified</span>
            ...
            <div className="flex items-center gap-3 bg-black/40 border border-white/10 rounded-lg p-4 group/chip hover:border-accent/50 transition-colors">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-bold text-white">IIT Dharwad</span>
